...
switch ($valorRadio) {
    case 'Pendiente':
        $sql = "SELECT t.nroArreglo, t.motivo, t.solucion, et.nombre, t.fechaProblema, t.fechaSolucion, t.nombreAfectado, a.nombre, CONCAT(u.nombre, ' ', u.apellido) AS nombre_apellido 
                ...
                WHERE t.estadoTarea_id = et.id AND t.area_codigo = a.codigo AND t.usuario_dni = u.dni AND t.estadoTarea_id IN (SELECT id FROM estadotarea WHERE nombre = 'Pendiente') ORDER BY t.fechaProblema DESC";
    ...
    case 'En_Progreso':
        $sql = "SELECT t.nroArreglo, t.motivo, t.solucion, et.nombre, t.fechaProblema, t.fechaSolucion, t.nombreAfectado, a.nombre, CONCAT(u.nombre, ' ', u.apellido) AS nombre_apellido 
                FROM tareas AS t, estadotarea AS et, areas AS a, usuario AS u
                WHERE t.estadoTarea_id = et.id AND t.area_codigo = a.codigo AND t.usuario_dni = u.dni AND t.estadoTarea_id IN (SELECT id FROM estadotarea WHERE nombre = 'En Progreso') ORDER BY t.fechaProblema DESC";
        $result = mysqli_query($link, $sql);
    ...
    case 'Completadas':
        $sql = "SELECT t.nroArreglo, t.motivo, t.solucion, et.nombre, t.fechaProblema, t.fechaSolucion, t.nombreAfectado, a.nombre, CONCAT(u.nombre, ' ', u.apellido) AS nombre_apellido 
                FROM tareas AS t, estadotarea AS et, areas AS a, usuario AS u
                WHERE t.estadoTarea_id = et.id AND t.area_codigo = a.codigo AND t.usuario_dni = u.dni AND t.estadoTarea_id IN (SELECT id FROM estadotarea WHERE nombre = 'Completo') ORDER BY t.fechaProblema DESC";
        $result = mysqli_query($link, $sql);
